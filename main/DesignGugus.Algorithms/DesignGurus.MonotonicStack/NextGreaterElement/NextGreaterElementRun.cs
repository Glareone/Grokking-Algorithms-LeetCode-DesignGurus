using DesignGurus.MonotonicStack.NextGreaterElement;

public sealed class NextGreaterElementRun
{
...
// Explanation: The next greater number for 4 is 5, for 2 is 4, and for 6 is 7 in nums2.
        ...
        Console.WriteLine($"find next greater numbers for num1 array: {string.Join(',', NextGreaterElementHelper.FindNextGreaterElementForArray(num1, num2))}");
...
// Explanation: The next greater number for 9 does not exist, for 7 is 9, and for 1 is 7 in nums2v2.
        ...
        Console.WriteLine($"find next greater numbers for num1 array: [{string.Join(',', NextGreaterElementHelper.FindNextGreaterElementForArray(num1v2, num2v2))}]");
...
// Explanation: The next greater number for 5 is 10, for 12 is 15, and for 3 is 5 in nums2v3.
        ...
        Console.WriteLine($"find next greater numbers for num1 array: [{string.Join(',', NextGreaterElementHelper.FindNextGreaterElementForArray(num1v3, num2v3))}]");
